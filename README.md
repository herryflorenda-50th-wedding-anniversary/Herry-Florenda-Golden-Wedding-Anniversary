...
## Updated guest list included

This package includes the latest guest CSV with 232 guests across 24 tables.
The app has also been updated to show a Total Tables metric and to load the latest guest list by default.
